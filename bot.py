...
async def status_task() -> None:
    ...
    user=len(bot.users)
    statuses = ["/ask_gpt", "/help", "with humans!", f"{guilds} guilds with {user} user"]
...
async def on_message(message: discord.Message) -> None:
    ...
    if bot.user.mention in message.content:
        embed=discord.Embed(title="Yoo , Ctrl is here", description=f"Hey {message.author.mention}\n You can use `>help` or `/help` for more info")
        embed.set_footer(text="Eat Sleep Code", icon_url=bot.user.display_avatar.url)
